 ...
 */
class getTransactionArgentRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TransactionArgentRepository' shared autowired service.
     *
     * @return \App\Repository\TransactionArgentRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TransactionArgentRepository.php';

        return $container->privates['App\\Repository\\TransactionArgentRepository'] = new \App\Repository\TransactionArgentRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
