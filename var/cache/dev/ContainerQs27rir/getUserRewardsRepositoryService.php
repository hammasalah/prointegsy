 ...
 */
class getUserRewardsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\UserRewardsRepository' shared autowired service.
     *
     * @return \App\Repository\UserRewardsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'UserRewardsRepository.php';

        return $container->privates['App\\Repository\\UserRewardsRepository'] = new \App\Repository\UserRewardsRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
