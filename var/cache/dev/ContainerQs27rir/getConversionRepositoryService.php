 ...
 */
class getConversionRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ConversionRepository' shared autowired service.
     *
     * @return \App\Repository\ConversionRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ConversionRepository.php';

        return $container->privates['App\\Repository\\ConversionRepository'] = new \App\Repository\ConversionRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
