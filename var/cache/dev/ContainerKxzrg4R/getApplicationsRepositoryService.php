 ...
 */
class getApplicationsRepositoryService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ApplicationsRepository.php';

        return $container->privates['App\\Repository\\ApplicationsRepository'] = new \App\Repository\ApplicationsRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
