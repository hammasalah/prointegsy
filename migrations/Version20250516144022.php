 ...
 */
final class Version20250516144022 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE visite_utilisateur (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, dernier_visite DATE NOT NULL, serie INT NOT NULL, INDEX IDX_A8D52305A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
