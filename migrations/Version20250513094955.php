 ...
 */
final class Version20250513094955 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE roulette ADD points_gagnes INT NOT NULL, DROP result, CHANGE created_at date DATETIME NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE roulette ADD result VARCHAR(255) NOT NULL, DROP points_gagnes, CHANGE date created_at DATETIME NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE user_groups CHANGE profile_picture profile_picture LONGTEXT DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE users CHANGE created_at created_at VARCHAR(255) DEFAULT NULL, CHANGE updated_at updated_at VARCHAR(255) DEFAULT NULL
        SQL);
    }
}
