 ...
 */
final class Version20250508141729 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        // SQL);
        // Commenté car la contrainte n'existe pas
        // $this->addSql(<<<'SQL'
        //     ALTER TABLE group_members DROP FOREIGN KEY FK_B8990FC89D86650F
        // SQL);
        // Commenté car la contrainte pourrait ne pas exister
        // $this->addSql(<<<'SQL'
        //     ALTER TABLE group_members DROP FOREIGN KEY FK_B8990FC82F68B530
        // SQL);
        // Commenté car la contrainte pourrait ne pas exister
        // $this->addSql(<<<'SQL'
        //     ALTER TABLE Likes DROP FOREIGN KEY FK_880B61799D86650F
        // SQL);
        // Commenté car les contraintes pourraient ne pas exister
        // $this->addSql(<<<'SQL'
        ...
        // SQL);
        // Table pourrait ne pas exister, commenté pour éviter l'erreur
        // $this->addSql(<<<'SQL'
        //     DROP TABLE Comments
        // SQL);
        // Table n'existe pas, commenté pour éviter l'erreur
        // $this->addSql(<<<'SQL'
        ...
        //     DROP TABLE Messages
        // SQL);
        // Toutes les instructions DROP TABLE sont commentées pour éviter les erreurs avec les tables qui n'existent pas
        // $this->addSql(<<<'SQL'
        //     DROP TABLE Shares
        // SQL);
        // $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        // Commenté pour éviter les erreurs avec les tables qui n'existent pas
        // $this->addSql(<<<'SQL'
        ...
        // SQL);
        // Commenté pour éviter les erreurs avec les tables qui pourraient déjà exister
        // $this->addSql(<<<'SQL'
        ...
        // Commenté pour éviter les erreurs avec les tables qui pourraient déjà exister
        // $this->addSql(<<<'SQL'
        //     CREATE TABLE group_members (id INT AUTO_INCREMENT NOT NULL, group_id_id INT NOT NULL, user_id_id INT NOT NULL, role VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, INDEX IDX_B8990FC82F68B530 (group_id_id), INDEX IDX_B8990FC89D86650F (user_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = '' 
        // SQL);
        // Commenté pour éviter les erreurs avec les tables qui pourraient déjà exister
        // $this->addSql(<<<'SQL'
        ...
        // SQL);
        // Commenté pour éviter les erreurs avec les contraintes qui pourraient ne pas exister
        // $this->addSql(<<<'SQL'
